...
import (
	...
	"github.com/vinamra28/tekton-trivy/pkg/app"
	"github.com/vinamra28/tekton-trivy/pkg/parser"
	"github.com/vinamra28/tekton-trivy/pkg/validator"
)
...
func Command(cli app.CLI) *cobra.Command {
	return &cobra.Command{
		Use:     "scan",
		Aliases: []string{"scan"},
		Short:   "Scans vulnerabilities in Tekton Tasks",
...
func validate(cli app.CLI, path string) error {
	...
	newRes, err := res.ToType()
	validator.Scanner(newRes)
